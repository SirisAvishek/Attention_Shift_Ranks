        ...
        try:
            ...
            if random_rois:
                ...
                if detection_targets:
                    rois, fpn_class_ids, fpn_bbox = build_detection_targets(rpn_rois, gt_class_ids, gt_boxes, config)
                ...
                if random_rois:
                    ...
                    if detection_targets:
                        ...
                        batch_fpn_class_ids = np.zeros(
                            (batch_size,) + fpn_class_ids.shape, dtype=fpn_class_ids.dtype)
                        batch_fpn_bbox = np.zeros(
                            (batch_size,) + fpn_bbox.shape, dtype=fpn_bbox.dtype)
            ...
            if b >= batch_size:
                ...
                if random_rois:
                    ...
                    if detection_targets:
                        ...
                        outputs.extend(
                            [batch_fpn_class_ids, batch_fpn_bbox])
...
def load_image_gt(dataset, config, image_id, augmentation=None):
    ...
    # Image meta data
    image_meta = model_utils.compose_image_meta(image_id, original_shape, image.shape,
...
def build_rpn_targets(image_shape, anchors, gt_class_ids, gt_boxes, config):
    ...
    # TODO: Assume no Crowd box in Visual Genome dataset,
    #   check for Crowds similar to COCO in Visual Genome
